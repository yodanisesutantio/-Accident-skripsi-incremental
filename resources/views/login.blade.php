...
@section('content')
    ...
    <div class="flex flex-col mt-8 lg:my-12 gap-5 lg:gap-7">
        <div class="flex flex-col gap-1">
            <label for="username" class="font-semibold font-league text-xl text-custom-grey">Username / Email<span class="text-custom-destructive">*</span></label>
    ...
    <div class="flex mt-5">
        <a href="/user-home" class="w-full py-3 rounded-lg lg:rounded-lg bg-custom-green hover:bg-custom-green-hover text-center lg:text-lg text-custom-white-hover font-semibold lg:order-2 duration-500">Login</a>
    </div>
