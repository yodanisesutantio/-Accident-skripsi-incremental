    ...
    <form action="/register" method="post">
        ...
        <div class="flex flex-col mt-4 gap-5 lg:gap-7">
            <div class="flex flex-col gap-1">
                ...
                <input type="text" name="fullname" id="fullname" placeholder="Nama Lengkap" class="p-4 font-league text-lg/[0] text-custom-secondary placeholder:#48484833 rounded-lg">
            </div>
            <div class="flex flex-col gap-1">
                ...
                <input type="text" name="username" id="username" placeholder="user_name_123" class="p-4 font-league text-lg/[0] text-custom-secondary placeholder:#48484833 rounded-lg">
            </div>
            <div class="flex flex-col gap-1">
                ...
                <div class="relative flex justify-end items-center">
                    <input type="password" name="password" id="password" placeholder="Password" class="relative py-4 pl-4 pr-10 w-full font-league text-lg/[0] text-custom-secondary placeholder:#48484833 rounded-lg">
